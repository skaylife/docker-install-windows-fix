Конечно! Вот обновленная версия вашего README с добавленным скриншотом ошибки при установке Docker под кодом ошибки.
...
Теперь все скриншоты добавлены в соответствующие разделы, и README выглядит готовым для использования.